...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('frontend/style.css') }}?v={{ filemtime(public_path('frontend/style.css')) }}">
    ...
    <footer class="py-5">
        <div class="container-fluid text-white">
            <div class="row">
                    ...
                    <div class="footer-menu">
                        ...
                        <div class="social-links">
                            ...
                            <ul class="d-flex list-unstyled gap-2">
                                ...
                                <li>
                                    <a href="{{$webSettings['instagram']??''}}" class="social-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="{{ $webSettings['linkedin'] ?? '' }}" class="social-icon">
                                ...
                                <li>
                                    <a href="{{$webSettings['youtube']??''}}" class="social-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <a href="{{ $webSettings['tiktok'] ?? '' }}" class="social-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                            viewBox="0 0 448 512" fill="currentColor">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-menu">
                        <h5 class="widget-title text-white">Layanan Pelanggan</h5>
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6" hidden>
                    <div class="footer-menu">
                        <h5 class="widget-title text-white">Berlangganan</h5>
